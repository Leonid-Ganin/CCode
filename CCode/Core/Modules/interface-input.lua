...
M.new = function(title, textListener, inputListener, oldText)
    if not M.group then
        ...
        M.bg = display.newRoundedRect(CENTER_X, CENTER_Y - 100, DISPLAY_WIDTH - 100, 130, 20)
            M.bg:setFillColor(0.2, 0.2, 0.22)
        M.group:insert(M.bg)

        M.box = native.newTextBox(5000, CENTER_Y - 120, DISPLAY_WIDTH - 150, system.getInfo 'environment' ~= 'simulator' and 36 or 72)
